...
K.clear_session()
data_entrenamiento = '/content/drive/My Drive/I^2GPF/DataSetBarbijosV2/Entrenamiento'
data_validacion = '/content/drive/My Drive/I^2GPF/DataSetBarbijosV2/Validacion'
...
dir = '/content/drive/My Drive/I^2GPF/ModeloEntrenado'

if not os.path.exists(dir):
  os.mkdir(dir)

cnn.save('/content/drive/My Drive/I^2GPF/ModeloEntrenado/modeloV2.h5')
cnn.save_weights('/content/drive/My Drive/I^2GPF/ModeloEntrenado/pesosV2.h5')